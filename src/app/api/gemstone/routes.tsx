const gemstone = {
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, this Ruby is 100% natural and laboratory certified.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Ruby is associated with the Sun (Surya).",
    },
  ],
  ...
  seo: {
    ...
    canonicalUrl:
      "https://example.com/gemstones/natural-ruby",
    ogTitle: "Natural Ruby Gemstone",
    ogDescription:
      "Premium certified Ruby gemstone for astrology and jewelry.",
    ogImage:
      "https://example.com/images/gemstones/ruby.webp",
  },
